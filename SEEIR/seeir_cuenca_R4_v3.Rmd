...
Los resultados sugieren que la matriz de Ecuador puede ser efectivamente representativa de las interacciones diarias entre los grupos de edad
...
El escenario actual se genera a partir de un modelo tomando en cuenta el comportamiento observado de movilidad según los datos de MINT1EL / Telefónica.

```{r leer datos de movilidad }
# Leer datos de movilidad

mov <- read.csv("G:/My Drive/geo/Ecuador/covid19/mintel/movilidad_procesado/canmov_semanal.csv", 
