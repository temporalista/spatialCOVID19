...
[
  ...
  hospitalized?        ;; If true, the person is hospitalized and will recovery in half the tiempo-promedio-recuperacion.
...
to crear-poblacion
  ...
  ask n-of (poblacion-p1) (patches with [pxcor < 0]) [sprout-p1s 1]
  ask n-of (poblacion-p2) (patches with [pxcor > 0]) [sprout-p2s 1]
...
to assign-tendency ;; Turtle procedure
  ...
  ask p1s [
    if (random-float 100 < p1-medidas-personales) [ set f-medidas-personales (1 / emp)]
    set tendencia-cuarentena random-normal p1-tendencia-cuarentena (p1-tendencia-cuarentena / 4)
    set tendencia-hospitalizacion random-normal p1-tendencia-hospitalizacion (p1-tendencia-hospitalizacion / 4)
      ]


    ask p2s [
    if (random-float 100 < p2-medidas-personales) [ set f-medidas-personales (1 / emp)]
    set tendencia-cuarentena random-normal p2-tendencia-cuarentena (p2-tendencia-cuarentena / 4)
    set tendencia-hospitalizacion random-normal p2-tendencia-hospitalizacion (p2-tendencia-hospitalizacion / 4)
      ]

  ask turtles [
  set recovery-time random-normal tiempo-promedio-recuperacion (tiempo-promedio-recuperacion / 4)

  ;; Make sure recovery-time lies between 0 and 2x tiempo-promedio-recuperacion
  if recovery-time > tiempo-promedio-recuperacion * 2 [ set recovery-time (tiempo-promedio-recuperacion * 2) ]
...
to infect  ;; turtle procedure
    ...
    [
       ...
       [
           ...
           [
             if random 100 < probabilidad-contagio * f-medidas-personales * 2 ;; twice as likely to infect a linked person
             [
               set infected? true
...
160
106
Efectividad medidas personalaes
7
0.0
1
...
"" ""
PENS
"P1" 1.0 0 -14333415 true "" "plot muertes-p1"
"P2" 1.0 0 -12186836 true "" "plot muertes-p2"
